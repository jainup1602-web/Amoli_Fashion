...
import { Plus, Edit, Trash2, Eye, EyeOff, Image as ImageIcon, Upload } from 'lucide-react';
...
export default function ShowcasesAdmin() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > 5 * 1024 * 1024) {
      alertError('Image size should be less than 5MB');
      return;
    }
                  ...
                  {uploading ? (
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-xs text-gray-500">
                        PNG, JPG up to 5MB (1200x1500px recommended)
                      </p>
                    </div>
                  )}
                </label>
