  ...
  return (
    <div className="bg-white border border-gray-100 p-4 sm:p-6">
      <div className="flex items-center gap-3 mb-4 pb-3 border-b border-gray-100">
        <Star className="h-5 w-5" style={{ color: '#1A1A1A' }} />
        <h2 className="text-base font-playfair text-[#1C1C1C]">Loyalty Points</h2>
        <span className="ml-auto text-sm font-bold" style={{ color: '#1A1A1A' }}>{points} pts</span>
      </div>
        ...
        <div>
          <label className="flex items-center gap-2 cursor-pointer mb-2">
            ...
            <span className="text-sm text-gray-700">
              Use {maxRedeemable} points = <strong style={{ color: '#1A1A1A' }}>₹{(maxRedeemable * RUPEE_PER_POINT).toFixed(0)} off</strong>
            </span>
          </label>
          {redeemPoints > 0 && (
