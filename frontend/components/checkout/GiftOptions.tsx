  ...
  return (
    <div className="bg-white border border-gray-100 p-4 sm:p-6">
      <div className="flex items-center gap-3 mb-4 pb-3 border-b border-gray-100">
        <Gift className="h-5 w-5" style={{ color: '#1A1A1A' }} />
        <h2 className="text-base font-playfair text-[#1C1C1C]">Gift Options</h2>
      </div>
      ...
      <label className="flex items-center gap-3 cursor-pointer mb-4">
        <div
          ...
          style={{ backgroundColor: isGift ? '#1A1A1A' : '#d1d5db' }}
      ...
      {isGift && (
        <div className="space-y-3 pl-2 border-l-2" style={{ borderColor: '#1A1A1A' }}>
          {/* Gift Wrap */}
          ...
          <div>
            ...
            <textarea
              ...
              maxLength={200}
              rows={3}
              className="w-full border border-gray-200 focus:border-[#1A1A1A] px-3 py-2 text-sm font-light outline-none resize-none rounded-none"
            />
