    ...
    <>
      ...
      <Link href={`/products/${product.slug}`}>
        <div className="group flex gap-0 bg-white border border-gray-100 hover:border-[#1A1A1A]/20 hover:shadow-sm transition-all duration-300 overflow-hidden">
          {/* Image — fixed width */}
          <div className="relative w-52 sm:w-64 flex-shrink-0 aspect-square overflow-hidden bg-[#FDFCF0]">
            <Image
            ...
            />
            {discount > 0 && (
              <div className="absolute top-3 left-3 text-white text-[10px] font-semibold px-2 py-0.5 tracking-widest uppercase" style={{ backgroundColor: '#1A1A1A' }}>
                -{discount}%
              </div>
            )}
            <div className="absolute top-3 right-3 text-white text-[10px] font-semibold px-2 py-0.5 tracking-widest uppercase border border-white/60" style={{ backgroundColor: '#1A1A1A' }}>
              New
            </div>
          </div>
          ...
          <div className="flex-1 min-w-0 p-6 flex flex-col justify-between">
            <div>
              ...
              {/* Name */}
              <h3 className="font-playfair text-lg text-[#1C1C1C] leading-snug mb-3 group-hover:text-[#1A1A1A] transition-colors line-clamp-2">
                {product.name}
              </h3>
              {/* Short description */}
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="p-2.5 border border-gray-200 hover:border-[#1A1A1A] transition-colors"
