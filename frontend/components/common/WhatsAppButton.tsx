...
export function WhatsAppButton() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('waHide', onHide);
    window.addEventListener('waShow', onShow);

    return () => {
      observer.disconnect();
      window.removeEventListener('waHide', onHide);
      window.removeEventListener('waShow', onShow);
    };
  }, []);
