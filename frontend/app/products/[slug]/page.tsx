...
export default function ProductDetailPage({ params }: { params: { slug: string } }) {
  ...
  const [openSections, setOpenSections] = useState<{ description: boolean; details: boolean; reviews: boolean }>({
    description: false,
    details: false,
    reviews: false,
  });
  ...
  return (
    <div className="min-h-screen bg-[#F9F5F2] overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">

        {/* Breadcrumb */}
        <div className="mb-6 text-xs font-elegant tracking-widest uppercase text-gray-500 overflow-hidden">
          <Breadcrumb items={[
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-fairplay text-[#1C1C1C] leading-snug mt-1">{product.name}</h1>
            ...
            <div className="flex items-end gap-3 border-t border-b border-gold/15 py-4">
              <span className="text-2xl sm:text-3xl font-medium text-[#1C1C1C]">{formatPrice(displayPrice)}</span>
        ...
        <div className="mt-16 space-y-3">
          ...
          <div className="border border-gray-200 bg-white overflow-hidden">
            ...
            >
              <span className="text-sm font-medium text-gray-800 tracking-wide uppercase">Description</span>
              <motion.div
              ...
              {openSections.description && (
                ...
                >
                  <div className="px-6 pb-6 pt-2 border-t border-gray-100">
                    <p className="text-gray-600 font-light leading-relaxed whitespace-pre-line text-sm">{product.description}</p>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
          ...
          <div className="border border-gray-200 bg-white overflow-hidden">
            <button
              ...
              className="w-full flex items-center justify-between px-6 py-4 text-left hover:bg-gray-50 transition-colors"
            >
              <span className="text-sm font-medium text-gray-800 tracking-wide uppercase">Details</span>
              <motion.div
                ...
                >
                  <div className="px-6 pb-6 pt-2 border-t border-gray-100">
                    {details.length > 0 ? (
                        ...
                        <tbody>
                          {details.map(({ label, value }) => (
                            <tr key={label} className="border-b border-gray-100 last:border-0">
                              <td className="py-3 pr-8 font-medium text-gray-800 w-1/3 text-xs uppercase tracking-wide">{label}</td>
                      ...
                      <p className="text-gray-400 font-light text-sm">No additional details available.</p>
                    )}
                  </div>
                </motion.div>
              )}
              ...
              {openSections.reviews && (
                ...
                >
                  <div className="px-6 pb-6 pt-2 border-t border-gray-100 space-y-6">
                    {/* Summary */}
                    {reviews.length > 0 && (
                      <div className="flex items-center gap-6 p-5 bg-[#F9F5F2] border border-gray-100 rounded">
                        <div className="text-center">
                          <div className="text-4xl font-semibold text-gray-800">{product.averageRating.toFixed(1)}</div>
                          <Rating rating={product.averageRating} />
                          <p className="text-xs text-gray-400 mt-1 uppercase tracking-wide">{product.totalReviews} reviews</p>
                        </div>
                            ...
                            <div className="flex items-start justify-between">
                              <div>
                                <div className="flex items-center gap-2">
                                  ...
                                  {review.isVerified && (
                                    <span className="text-[10px] uppercase tracking-wide text-green-600 flex items-center gap-1">
                    ...
                    <div className="border-t border-gray-200 pt-6">
                      <div className="text-center py-6 border border-gray-200 bg-[#F9F5F2] rounded">
