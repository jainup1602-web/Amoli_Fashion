...
export default function ProductsPage() {
  ...
  // Read URL param and apply category filter once categories are loaded
  useEffect(() => {
    ...
    <div className="min-h-screen bg-[#F9F7F4]">
      ...
      <div className="flex min-h-screen">
        ...
        <main className="flex-1 min-w-0">
          ...
          {/* Toolbar */}
          <div className="bg-white border-b border-gray-100 px-3 sm:px-5 py-2.5 sm:py-3 flex items-center gap-2 sm:gap-3 sticky top-0 z-10">
            ...
            {/* Count */}
            <span className="text-[10px] sm:text-[11px] tracking-widest uppercase text-gray-400 hidden lg:block flex-shrink-0">
              {loading ? '—' : `${totalCount} Designs`}
            </span>

            <div className="flex items-center gap-2 ml-auto flex-shrink-0">
              {/* Grid toggle — hide on mobile */}
