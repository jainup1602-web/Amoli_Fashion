  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FDFCF0' }}>
      ...
      <section className="relative py-20 sm:py-28 text-center overflow-hidden" style={{ backgroundColor: '#1A1A1A' }}>
        ...
        <FadeInSection direction="up" duration={0.6} className="relative z-10 max-w-3xl mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {[
              ...
              <FadeInSection key={item.title} direction="up" delay={i * 0.1}>
                <div className="text-center p-6 border border-gray-100 rounded-sm hover:border-[#1A1A1A]/30 transition-colors hover-lift">
        ...
        <FadeInSection direction="up">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={item.label} className={`flex items-center gap-3 p-4 rounded-sm border hover-scale ${item.yes ? 'border-green-100 bg-green-50' : 'border-red-100 bg-red-50'}`}>
