...
export const metadata: Metadata = {
  ...
  description:
    'Learn about Amoli Fashion Jewellery — born in the heart of Jaipur, Rajasthan. We craft premium demi-fine brass & stainless steel jewellery that is handcrafted, nickel-free, skin-friendly & anti-tarnish. Discover our story, mission & Rajasthani heritage.',
  keywords: [
    // Page Specific
    'about Amoli Fashion Jewellery', 'Amoli jewellery story', 'handcrafted jewellery Jaipur',
    'Rajasthani jewellery heritage', 'demi-fine jewellery brand India', 'brass jewellery Jaipur',
    'skin-friendly jewellery brand', 'jewellery brand Rajasthan', 'fashion jewellery manufacturer Jaipur',
    'Amoli founder story', 'Amoli jewellery values', 'authentic Jaipur jewellery', 'handmade jewellery brand',
    'Indian jewellery brand online', 'best artificial jewellery brand', 'trusted jewellery brand India',
    'premium imitation jewellery brand', 'sustainable jewellery India', 'ethical jewellery brand India',
    'artisan jewellery Jaipur', 'traditional jewellery makers Rajasthan', 'modern demi-fine jewellery',
    // Brand & General
  ...
  openGraph: {
    title: 'About Amoli Fashion Jewellery – Handcrafted in Jaipur, Rajasthan',
    description:
      'Born in Rajasthan\'s jewellery heritage. Premium handcrafted brass & stainless steel jewellery — nickel-free, anti-tarnish, skin-friendly.',
    url: `${baseUrl}/about`,
