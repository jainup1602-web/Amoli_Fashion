...
export const metadata: Metadata = {
  ...
  description:
    'Learn about Amoli Fashion Jewellery shipping policy. Free shipping on orders above ₹499. We deliver across India — Jaipur, Ajmer, Beawar, Delhi, Mumbai & all cities. Estimated delivery 3-7 business days.',
  keywords: [
    // Page Specific
    'Amoli shipping policy', 'jewellery delivery India', 'free shipping jewellery',
    'jewellery delivery time', 'fashion jewellery shipping', 'jewellery delivery Jaipur',
    'jewellery delivery Ajmer', 'jewellery courier service', 'international shipping jewellery',
    'cash on delivery jewellery India', 'how to track jewellery order', 'Amoli dispatch time',
    'fast delivery jewellery online', 'same day delivery jewellery Jaipur', 'secure shipping jewellery',
    'jewellery packaging India', 'shipping charges for artificial jewellery',
    // Brand & General
  ...
  alternates: { canonical: `${baseUrl}/shipping-policy` },
};
