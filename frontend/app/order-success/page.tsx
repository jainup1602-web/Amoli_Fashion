  ...
  return (
    <div className="min-h-screen bg-[#F9F5F2] flex items-center justify-center py-16 px-4">
      <div className="w-full max-w-lg text-center">
        <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-8" style={{ backgroundColor: '#1A1A1A' }}>
          <Check className="h-10 w-10 text-white" strokeWidth={2.5} />
        </div>
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-playfair text-[#1C1C1C] mb-3">Order Confirmed!</h1>
        ...
        <div className="bg-white border border-gray-100 p-6 mb-8 text-left space-y-5">
          <div className="flex items-start gap-4">
            <Package className="h-5 w-5 mt-0.5 flex-shrink-0" style={{ color: '#1A1A1A' }} />
            <div>
          ...
          <div className="flex items-start gap-4">
            <Truck className="h-5 w-5 mt-0.5 flex-shrink-0" style={{ color: '#1A1A1A' }} />
            <div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Button asChild className="text-white rounded-none border-none tracking-widest uppercase text-xs h-10 px-6" style={{ backgroundColor: '#1A1A1A' }}>
            <Link href="/account/orders">View My Orders</Link>
          </Button>
          <Button asChild variant="outline" className="rounded-none border-gray-300 text-[#1C1C1C] hover:border-[#1A1A1A] tracking-widest uppercase text-xs h-10 px-6">
