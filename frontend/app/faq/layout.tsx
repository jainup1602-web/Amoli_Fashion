...
export const metadata: Metadata = {
  ...
  description:
    'Find answers to common questions about Amoli Fashion Jewellery — orders, shipping, returns, jewellery care, materials & more. We ship across India from Jaipur, Rajasthan.',
  keywords: [
    // Page Specific
    'Amoli jewellery FAQ', 'jewellery ordering help', 'fashion jewellery questions',
    'jewellery shipping India', 'jewellery return policy', 'brass jewellery care',
    'nickel-free jewellery FAQ', 'jewellery order tracking India', 'cash on delivery jewellery FAQ',
    'Amoli customer support questions', 'jewellery exchange policy', 'how to order jewellery online',
    'artificial jewellery durability', 'how long does plated jewellery last', 'hypoallergenic jewellery questions',
    'buying jewellery online guide', 'is Amoli jewellery safe for skin', 'Amoli payment options',
    'jewellery delivery times India',
    // Brand & General
