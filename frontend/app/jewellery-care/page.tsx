...
export default function JewelleryCarePage() {
  ...
  const fetchPageContent = async () => {
    try {
      const res = await fetch('/api/cms-pages/jewellery-care');
        ...
        <div className="container-custom py-12">
          ...
          <Card className="p-12 text-center max-w-2xl mx-auto">
            ...
            <p className="text-gray-600">
              The Jewellery Care page content is not available. Please contact the administrator.
            </p>
          </Card>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#FDFCF0]">
      <div className="container-custom py-12">
        ...
        <div className="max-w-4xl mx-auto">
          <h1 className="text-2xl sm:text-4xl font-bold mb-4 sm:mb-6">{pageContent.title}</h1>
