      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        <div className="mt-4 sm:mt-6">
          <div className="flex items-center justify-between mb-4 sm:mb-6">
            ...
            {!editing && (
              <Button onClick={() => setEditing(true)} variant="outline" size="sm" className="text-xs">
          ...
          <Card className="p-4 sm:p-8">
            <form onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    ...
                    {editing ? (
                      ...
                      <p className="text-gray-900 py-1.5 text-sm">{formData.displayName || '-'}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {editing ? (
                      ...
                      <div>
                        <p className="text-gray-900 py-1.5 text-sm">{formData.email || '-'}</p>
                        {formData.email && (
                  ...
                  <div>
                    ...
                    {editing ? (
                      ...
                      <p className="text-gray-900 py-1.5 text-sm">{formData.phoneNumber || '-'}</p>
                    )}
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 gap-4 sm:gap-6">
                  <div>
                    ...
                    {editing ? (
                      ...
                      <p className="text-gray-900 py-1.5 text-sm">{formData.address || '-'}</p>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-3 sm:gap-6">
                    <div>
                      ...
                      {editing ? (
                        ...
                        <p className="text-gray-900 py-1.5 text-sm">{formData.city || '-'}</p>
                      )}
                    </div>
                    <div>
                      ...
                      {editing ? (
                        ...
                        <p className="text-gray-900 py-1.5 text-sm">{formData.state || '-'}</p>
                      )}
                    </div>
                    <div>
                      <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1.5">Pincode</label>
                      {editing ? (
                        <Input value={formData.pincode} onChange={(e) => setFormData({ ...formData, pincode: e.target.value })} placeholder="123456" />
                      ) : (
                        <p className="text-gray-900 py-1.5 text-sm">{formData.pincode || '-'}</p>
                      )}
                    </div>
                  </div>
                </div>
              ...
              {/* Action Buttons */}
              {editing && (
                <div className="flex gap-3 mt-5 sm:mt-8 pt-5 sm:pt-8 border-t">
