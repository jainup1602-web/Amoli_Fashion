  ...
  const policies = [
    {
      ...
      icon: <RotateCcw className="w-6 h-6" style={{ color: '#B76E79' }} />,
      content: (
        <div className="space-y-3 text-gray-600 leading-relaxed font-light">
          ...
          <ul className="space-y-2 mt-2">
            <li className="flex items-start gap-2">
              <span className="w-1.5 h-1.5 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: '#B76E79' }} />
      ...
      content: (
        <div className="space-y-3 text-gray-600 leading-relaxed font-light">
          ...
          <div className="flex items-start gap-3 mt-4 p-4 border rounded-sm bg-gray-50/50" style={{ borderColor: 'rgba(183, 110, 121, 0.2)' }}>
            <Video className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: '#B76E79' }} />
            <p className="text-sm">
    ...
    },
    {
      ...
      icon: <MousePointer2 className="w-6 h-6" style={{ color: '#B76E79' }} />,
      content: (
        <ol className="space-y-4 text-gray-600 font-light list-decimal list-inside ml-2">
          <li>
            Go to the Return/Exchange section on the Amoli website or app menu, or follow this link: <Link href="/account/orders" className="text-[#B76E79] hover:underline font-medium">My Orders</Link>.
          </li>
          <li>
    ...
    },
    {
      ...
      icon: <Gem className="w-6 h-6" style={{ color: '#B76E79' }} />,
      content: (
        <div className="space-y-3 text-gray-600 leading-relaxed font-light">
          <p>
    ...
    },
    {
      ...
      icon: <Ban className="w-6 h-6" style={{ color: '#B76E79' }} />,
      content: (
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#F8F6F2' }}>
      ...
      <div className="max-w-5xl mx-auto px-4 pb-24 pt-8">
        ...
        <div className="mt-16 text-center border-t border-gray-200 pt-16">
          <h2 className="text-2xl font-fairplay text-gray-900 mb-4 tracking-wide">Still have questions?</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-8">
            <div>
              ...
              <a href="mailto:support@amoli.com" className="text-gray-900 font-medium hover:text-[#B76E79] transition-colors">support@amoli.com</a>
            </div>
            ...
            <div>
              ...
              <a href="tel:+911234567890" className="text-gray-900 font-medium hover:text-[#B76E79] transition-colors">+91 123 456 7890</a>
            </div>
          </div>
        </div>
      </div>
